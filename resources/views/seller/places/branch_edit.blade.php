...
@section('css')
    @toastr_css
@section('title')
    {{ trans('sellers_places.edit_branch') }}
@stop
@endsection
@section('page-header')
...
{{--                    @endif--}}
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            ...
                            <form action="{{\LaravelLocalization::localizeURL(route('edit.branch.seller.submit' , [$place , $placeRegion]))}}" method="post" enctype="multipart/form-data">
                                @csrf
...
{{--                                    <input type="hidden" value="{{$placeRegion}}" name="place_region" />--}}
                                    ...
                                    <div class="text-center w-25 search-custom">
                                        ...
                                        <div>
                                            <div class="col">
                                                <input   type="text" placeholder="{{trans('sellers_places.seller')}}" value="{{old('my_region_name' , $placeRegion->regions->government . ' , ' .  $placeRegion->regions->city . ' , ' .  $placeRegion->regions->district  )}}" class="form-control" name="my_region_name" id="my_region_name">
