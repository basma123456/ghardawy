...
@section('css')
    @toastr_css
@section('title')
    {{ trans('sellers_places.add_place') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                ...
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            ...
                            <form action="{{\LaravelLocalization::localizeURL(route('places_sellers.store'))}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="form-row">
                                    <div class="col">
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <select name="category" class="form-control p-2  w-25">
                                            <option>{{trans('sellers_places.Choose_category')}}</option>
                                            @foreach($categories as $category)
                                                <option class="form-control"  value="{{(int)$category->id}}" {{ old('category') == (int)$category->id ? 'selected' : '' }} >{{$category->title}}</option>
                                            @endforeach
                                        </select>
                                        @error('category')
                                        <div class="alert alert-danger">{{$message}}</div>
...
{{--                                        <input type="text" name="search" id="search" class="form-control"  value="{{old('search')}}" placeholder="{{trans('sellers_places.search_here')}}" /><span class='hide btn btn-secondary btn-sm float-right' id='x_dismiss'>x</span>--}}
{{--                                    </div>--}}
{{--                                    <div id="search_list">--}}
...
{{--                                <div class="form-row">--}}
{{--                                    <div class="col">--}}
{{--                                        <label for="my_seller_name">{{trans('sellers_places.seller')}}</label>--}}
...
{{--                                </div>--}}
                                ...
                                <br>
                                <br>
                                <button class="btn btn-success btn-sm nextBtn btn-lg pull-right w-25" type="submit">{{trans('sellers_places.Next')}}</button>
