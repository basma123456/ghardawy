                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        ...
                                        <select class="custom-select my-1 mr-sm-2 form-control" style="height: max-content" name="status">
                                            ...
                                            <option {{$category->status===(int)0 ? 'selected' : ''}} value="{{(int)0}}">{{trans('Parent_trans.deactive')}}</option>
                                            <option {{$category->status===(int)1 ? 'selected' : ''}}  value="{{(int)1}}">{{trans('Parent_trans.active')}}</option>
