...
@section('css')
    @toastr_css
@section('title')
    {{ trans('admin_places.update_place') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                ...
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            ...
                            <form action="{{\LaravelLocalization::localizeURL(route('places.update', $place->id))}}" method="post" enctype="multipart/form-data">
                                @method('Put')
                                @csrf
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        ...
                                        <select class="custom-select my-1 mr-sm-2 form-control" style="height: max-content" name="status">
                                            ...
                                            <option value="{{(int)0}}" {{ old('status' , (int)$place->status) == (int)0 ? 'selected' : '' }}>{{trans('admin_places.deactive')}}</option>
                                            <option value="{{(int)1}}" {{ old('status' , (int)$place->status) == (int)1 ? 'selected' : '' }}>{{trans('admin_places.active')}}</option>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <select name="category" class="form-control p-2">
                                            <option>{{trans('admin_places.Choose_category')}}</option>
