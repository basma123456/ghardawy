...
@section('css')
    @toastr_css
@section('title')
    {{ trans('admin_about_page.edit_about_page') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                ...
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            ...
                            <form action="{{\LaravelLocalization::localizeURL(route('about_page.update' , $about->id))}}" method="post" enctype="multipart/form-data">
                            @method('Put')
                            @csrf
                            <!-------------------------------upper_paragraphs part------------------------->
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <input type="text"  value="{{old('upper_paragraphs1_ar', explode('-' , $about->getTranslation('upper_paragraphs', 'ar'))[0]  )}}"  required name="upper_paragraphs1_ar" class="form-control">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text"  value="{{old('upper_paragraphs1_en',  explode('-' ,  $about->getTranslation('upper_paragraphs', 'en'))[0] )}}"   required name="upper_paragraphs1_en" class="form-control">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" value="{{old('upper_paragraphs1_ru', explode('-' ,  $about->getTranslation('upper_paragraphs', 'ru'))[0] )}}"    required name="upper_paragraphs1_ru" class="form-control">
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <input type="text"  value="{{old('upper_paragraphs2_ar', explode('-' , $about->getTranslation('upper_paragraphs', 'en'))[1] )}}"   required name="upper_paragraphs2_ar" class="form-control">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" value="{{old('upper_paragraphs2_en', explode('-' , $about->getTranslation('upper_paragraphs', 'en'))[1]  )}}"   required name="upper_paragraphs2_en" class="form-control">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" value="{{old('upper_paragraphs2_ru',  explode('-' ,  $about->getTranslation('upper_paragraphs', 'ru'))[1]  )}}"    required name="upper_paragraphs2_ru" class="form-control">
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <input type="text" value="{{old('upper_paragraphs3_ar',  explode('-' ,  $about->getTranslation('upper_paragraphs', 'ar'))[2]  )}}"     required name="upper_paragraphs3_ar" class="form-control">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" value="{{old('upper_paragraphs3_en',  explode('-' , $about->getTranslation('upper_paragraphs', 'en'))[2]  )}}"    required name="upper_paragraphs3_en" class="form-control">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text"  value="{{old('upper_paragraphs3_ru',  explode('-' , $about->getTranslation('upper_paragraphs', 'ru'))[2])}}"   required name="upper_paragraphs3_ru" class="form-control">
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <input type="text" value="{{old('upper_paragraphs4_ar',  explode('-' , $about->getTranslation('upper_paragraphs', 'ar'))[3] )}}"    required name="upper_paragraphs4_ar" class="form-control">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" value="{{old('upper_paragraphs4_en',  explode('-' , $about->getTranslation('upper_paragraphs', 'en'))[3])}}"   required name="upper_paragraphs4_en" class="form-control">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" value="{{old('upper_paragraphs4_ru', explode('-' , $about->getTranslation('upper_paragraphs', 'ru'))[3] )}}"    required name="upper_paragraphs4_ru" class="form-control">
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <textarea  required name="how_we_work_paragraphs1_ar"   class="form-control" rows="4">  {{old('how_we_work_paragraphs1_ar',  explode('-' , $about->getTranslation('how_we_work_paragraphs', 'ar'))[0])}}  </textarea>
                                    ...
                                    <div class="col">
                                        ...
                                        <textarea  required name="how_we_work_paragraphs1_en"  class="form-control" rows="4">  {{old('how_we_work_paragraphs1_en',  explode('-' , $about->getTranslation('how_we_work_paragraphs', 'en'))[0])}}   </textarea>
                                    ...
                                    <div class="col">
                                        ...
                                        <textarea  required name="how_we_work_paragraphs1_ru" class="form-control" rows="4">  {{old('how_we_work_paragraphs1_ru',  explode('-' , $about->getTranslation('how_we_work_paragraphs', 'ru'))[0])}}  </textarea>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <textarea  required name="how_we_work_paragraphs2_ar"   class="form-control" rows="4">  {{old('how_we_work_paragraphs2_ar',  explode('-' , $about->getTranslation('how_we_work_paragraphs', 'ar'))[1])}}  </textarea>
                                    ...
                                    <div class="col">
                                        ...
                                        <textarea  required name="how_we_work_paragraphs2_en"  class="form-control" rows="4">{{old('how_we_work_paragraphs2_en',  explode('-' , $about->getTranslation('how_we_work_paragraphs', 'en'))[1])}}  </textarea>
                                    ...
                                    <div class="col">
                                        ...
                                        <textarea  required name="how_we_work_paragraphs2_ru" class="form-control" rows="4"> {{old('how_we_work_paragraphs2_ru',  explode('-' , $about->getTranslation('how_we_work_paragraphs', 'ru'))[1])}}   </textarea>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <textarea  required name="how_we_work_paragraphs3_ar"   class="form-control" rows="4">  {{old('how_we_work_paragraphs3_ar',  explode('-' , $about->getTranslation('how_we_work_paragraphs', 'ar'))[2])}}  </textarea>
                                    ...
                                    <div class="col">
                                        ...
                                        <textarea  required name="how_we_work_paragraphs3_en"  class="form-control" rows="4">  {{old('how_we_work_paragraphs3_en',  explode('-' , $about->getTranslation('how_we_work_paragraphs', 'en'))[2])}}  </textarea>
                                    ...
                                    <div class="col">
                                        ...
                                        <textarea  required name="how_we_work_paragraphs3_ru" class="form-control" rows="4"> {{old('how_we_work_paragraphs3_ru',  explode('-' , $about->getTranslation('how_we_work_paragraphs', 'ru'))[2])}} </textarea>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <textarea  required name="how_we_work_paragraphs4_ar"   class="form-control" rows="4"> {{old('how_we_work_paragraphs4_ar',  explode('-' , $about->getTranslation('how_we_work_paragraphs', 'ar'))[3])}}   </textarea>
                                    ...
                                    <div class="col">
                                        ...
                                        <textarea  required name="how_we_work_paragraphs4_en"  class="form-control" rows="4"> {{old('how_we_work_paragraphs4_en',  explode('-' , $about->getTranslation('how_we_work_paragraphs', 'en'))[3])}} </textarea>
                                    ...
                                    <div class="col">
                                        ...
                                        <textarea  required name="how_we_work_paragraphs4_ru" class="form-control" rows="4">{{old('how_we_work_paragraphs4_ru',  explode('-' , $about->getTranslation('how_we_work_paragraphs', 'ru'))[3])}}  </textarea>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <textarea  required name="how_we_work_paragraphs5_ar"   class="form-control" rows="4">{{old('how_we_work_paragraphs5_ar',  explode('-' , $about->getTranslation('how_we_work_paragraphs', 'ar'))[4])}}  </textarea>
                                    ...
                                    <div class="col">
                                        ...
                                        <textarea  required name="how_we_work_paragraphs5_en"  class="form-control" rows="4">{{old('how_we_work_paragraphs5_en',  explode('-' , $about->getTranslation('how_we_work_paragraphs', 'en'))[4])}}   </textarea>
                                    ...
                                    <div class="col">
                                        ...
                                        <textarea  required name="how_we_work_paragraphs5_ru" class="form-control" rows="4">{{old('how_we_work_paragraphs5_ru',  explode('-' , $about->getTranslation('how_we_work_paragraphs', 'ru'))[4])}} </textarea>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <textarea  required name="how_we_work_paragraphs6_ar"   class="form-control" rows="4">{{old('how_we_work_paragraphs6_ar',  explode('-' , $about->getTranslation('how_we_work_paragraphs', 'ar'))[5])}}  </textarea>
                                    ...
                                    <div class="col">
                                        ...
                                        <textarea  required name="how_we_work_paragraphs6_en"  class="form-control" rows="4">{{old('how_we_work_paragraphs6_en',  explode('-' , $about->getTranslation('how_we_work_paragraphs', 'en'))[5])}}  </textarea>
                                    ...
                                    <div class="col">
                                        ...
                                        <textarea  required name="how_we_work_paragraphs6_ru" class="form-control" rows="4">{{old('how_we_work_paragraphs6_ru',  explode('-' , $about->getTranslation('how_we_work_paragraphs', 'ru'))[5])}}  </textarea>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <textarea  required name="how_we_work_paragraphs7_ar"   class="form-control" rows="4">{{old('how_we_work_paragraphs7_ar',  explode('-' , $about->getTranslation('how_we_work_paragraphs', 'ar'))[6])}}    </textarea>
                                        ...
                                        <textarea  required name="how_we_work_paragraphs7_en"  class="form-control" rows="4">{{old('how_we_work_paragraphs7_en',  explode('-' , $about->getTranslation('how_we_work_paragraphs', 'en'))[6])}}  </textarea>
                                    ...
                                    <div class="col">
                                        ...
                                        <textarea  required name="how_we_work_paragraphs7_ru" class="form-control" rows="4">{{old('how_we_work_paragraphs7_ru',  explode('-' , $about->getTranslation('how_we_work_paragraphs', 'ru'))[6])}}  </textarea>
