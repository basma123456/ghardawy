            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            <br>
                            <form action="{{route('main.update' , $mains->id)}}" method="post" enctype="multipart/form-data">
                                @method('Put')
                                @csrf
                                <input type="hidden" name="id" value="{{$mains->id}}" />
                                <div class="form-row">
                                    <div class="col">
                                        <label for="title1_ar">{{trans('Teacher_trans.title1_ar')}}</label>
                                        <input type="text"  value="{{old('title1_ar', $mains->getTranslation('title1', 'ar'))}}" name="title1_ar" class="form-control">
                                        @error('title1_ar')
                                        <div class="alert alert-danger">{{$message}}</div>
                                        @enderror
                                    </div>
                                    <div class="col">
                                        <label for="title1_en">{{trans('Teacher_trans.title1_en')}}</label>
                                        <input type="text"  value="{{old('title1_en', $mains->getTranslation('title1', 'en'))}}" name="title1_en" class="form-control">
                                        @error('title1_en')
                                        <div class="alert alert-danger">{{$message}}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col">
                                        <label for="title1_ru">{{trans('Teacher_trans.title1_ru')}}</label>
                                        <input type="text"  value="{{old('title1_ru', $mains->getTranslation('title1', 'ru'))}}"  name="title1_ru" class="form-control">
                                        @error('title1_ru')
                                        <div class="alert alert-danger">{{$message}}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <input type="text"  value="{{old('title2_ar', $mains->getTranslation('title2', 'ar'))}}"    name="title2_ar" class="form-control">
                                        @error('title2_ar')
                                        <div class="alert alert-danger">{{$message}}</div>
                                        @enderror
                                    </div>
                                    <div class="col">
                                        ...
                                        <input type="text"  value="{{old('title2_en', $mains->getTranslation('title2', 'en'))}}"  name="title2_en" class="form-control">
                                        @error('title2_en')
                                        <div class="alert alert-danger">{{$message}}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text"  value="{{old('title2_ru', $mains->getTranslation('title2', 'ru'))}}" name="title2_ru" class="form-control">
                                        @error('title2_ru')
                                        <div class="alert alert-danger">{{$message}}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <textarea name="top_desc_ar"   class="form-control"   rows="4">{{old('top_desc_ar', $mains->getTranslation('top_desc', 'ar'))}}</textarea>
                                        @error('top_desc_ar')
                                        <div class="alert alert-danger">{{$message}}</div>
                                        @enderror
                                    </div>
                                    <div class="col">
                                        ...
                                        <textarea name="top_desc_en"  class="form-control" rows="4">{{old('top_desc_en', $mains->getTranslation('top_desc', 'en'))}}</textarea>
                                        @error('top_desc_en')
                                        <div class="alert alert-danger">{{$message}}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <textarea name="top_desc_ru" class="form-control" rows="4">{{old('top_desc_ru', $mains->getTranslation('top_desc', 'ru'))}}</textarea>
                                        @error('top_desc_ru')
                                        <div class="alert alert-danger">{{$message}}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <textarea name="left_desc_ar" class="form-control" rows="4">{{old('left_desc_ar', $mains->getTranslation('left_desc', 'ar'))}}</textarea>
                                        @error('left_desc_ar')
                                        <div class="alert alert-danger">{{$message}}</div>
                                        @enderror
                                    </div>
                                    <div class="col">
                                        ...
                                        <textarea name="left_desc_en" class="form-control" rows="4">{{old('left_desc_en', $mains->getTranslation('left_desc', 'en'))}}</textarea>
                                        @error('left_desc_en')
                                        <div class="alert alert-danger">{{$message}}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <textarea name="left_desc_ru" class="form-control" rows="4">{{old('left_desc_ru', $mains->getTranslation('left_desc', 'ru'))}}</textarea>
                                        @error('left_desc_ru')
                                        <div class="alert alert-danger">{{$message}}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <textarea name="middle_desc_ar" class="form-control" rows="4">{{old('middle_desc_ar', $mains->getTranslation('middle_desc', 'ar'))}}</textarea>
                                    ...
                                    <div class="col">
                                        ...
                                        <textarea name="middle_desc_en" class="form-control" rows="4">{{old('middle_desc_en', $mains->getTranslation('middle_desc', 'en'))}}</textarea>
                                    ...
                                    <div class="col">
                                        ...
                                        <textarea name="middle_desc_ru" class="form-control" rows="4">{{old('middle_desc_ru', $mains->getTranslation('middle_desc', 'ru'))}}</textarea>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <textarea name="right_desc_ar" class="form-control" rows="4">{{old('right_desc_ar', $mains->getTranslation('right_desc', 'ar'))}}</textarea>
                                        @error('right_desc_ar')
                                        <div class="alert alert-danger">{{$message}}</div>
                                        @enderror
                                    </div>
                                    <div class="col">
                                        ...
                                        <textarea name="right_desc_en" class="form-control" rows="4">{{old('right_desc_en', $mains->getTranslation('right_desc', 'en'))}}</textarea>
                                        @error('right_desc_en')
                                        <div class="alert alert-danger">{{$message}}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <textarea name="right_desc_ru" class="form-control" rows="4">{{old('right_desc_ru', $mains->getTranslation('right_desc', 'ru'))}}</textarea>
                                        @error('right_desc_ru')
                                        <div class="alert alert-danger">{{$message}}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <input type="text" name="website"  value="{{old('website', $mains->website)}}" class="form-control" >
                                        @error('website')
                                        <div class="alert alert-danger">{{$message}}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        ...
                                        <select class="custom-select my-1 mr-sm-2 form-control" style="height: max-content" name="left_upper_cat">
                                            ...
                                            @foreach($cats as $cat)
                                                <option value="{{(int)$cat->id}}" {{ old('left_upper_cat' , $mains->left_upper_cat) == (int)$cat->id ? 'selected' : '' }}>{{$cat->title}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        ...
                                        <select class="custom-select my-1 mr-sm-2 form-control" style="height: max-content" name="right_upper_cat">
                                            <option>{{trans('Parent_trans.Choose')}} <span class="text-dark">&#x26DB;</span></option>
                                            @foreach($cats as $cat)
                                                <option value="{{(int)$cat->id}}" {{ old('right_upper_cat' , $mains->right_upper_cat) == (int)$cat->id ? 'selected' : '' }}>{{$cat->title}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        ...
                                        <select class="custom-select my-1 mr-sm-2 form-control" style="height: max-content" name="screen_cat">
                                            <option>{{trans('Parent_trans.Choose')}} <span class="text-dark">&#x26DB;</span></option>
                                            @foreach($cats as $cat)
                                                <option value="{{(int)$cat->id}}" {{ old('screen_cat', $mains->screen_cat) == (int)$cat->id ? 'selected' : '' }}>{{$cat->title}}</option>
                                            @endforeach
                                        </select>
                                        @error('screen_cat')
                                        <div class="alert alert-danger">{{$message}}</div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        ...
                                        <select class="custom-select my-1 mr-sm-2 form-control" style="height: max-content" name="bottom_big_cat">
                                            <option>{{trans('Parent_trans.Choose')}} <span class="text-dark">&#x26DB;</span></option>
                                            @foreach($cats as $cat)
                                                <option value="{{(int)$cat->id}}" {{ old('bottom_big_cat', $mains->bottom_big_cat) == (int)$cat->id ? 'selected' : '' }}>{{$cat->title}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        ...
                                        <select class="custom-select my-1 mr-sm-2 form-control" style="height: max-content" name="bottom_left_upper_cat">
                                            <option>{{trans('Parent_trans.Choose')}} <span class="text-dark">&#x26DB;</span></option>
                                            @foreach($cats as $cat)
                                                <option value="{{(int)$cat->id}}" {{ old('bottom_left_upper_cat', $mains->bottom_left_upper_cat) == (int)$cat->id ? 'selected' : '' }}>{{$cat->title}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        ...
                                        <select class="custom-select my-1 mr-sm-2 form-control" style="height: max-content" name="bottom_left_lower_cat">
                                            <option>{{trans('Parent_trans.Choose')}} <span class="text-dark">&#x26DB;</span></option>
                                            @foreach($cats as $cat)
                                                <option value="{{(int)$cat->id}}" {{ old('bottom_left_lower_cat', $mains->bottom_left_lower_cat) == (int)$cat->id ? 'selected' : '' }}>{{$cat->title}}</option>
                                            @endforeach
                                        </select>
