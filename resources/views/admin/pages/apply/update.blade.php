...
@section('css')
    @toastr_css
@section('main_p')
    {{ trans('admin_apply.edit_apply_page') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
 ...
 {{--   //here       main_p first_p second_p third_p image label news_cat_id admin_id super_admin_id--}}
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        <label for="status">{{trans('admin_apply.image')}}</label>
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        ...
                                        <select class="custom-select my-1 mr-sm-2 form-control" style="height: max-content" name="news_cat_id">
                                            <option disabled>{{trans('admin_apply.Choose')}} <span class="text-dark">&#x26DB;</span></option>
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        ...
                                        <select class="custom-select my-1 mr-sm-2 form-control" style="height: max-content" name="status">
                                            <option disabled>{{trans('admin_apply.Choose')}} <span class="text-dark">&#x26DB;</span></option>
                                            <option {{$new->status===(int)0 ? 'selected' : ''}} value="{{(int)0}}">{{trans('admin_apply.deactive')}}</option>
                                            <option {{$new->status===(int)1 ? 'selected' : ''}}  value="{{(int)1}}">{{trans('admin_apply.active')}}</option>
